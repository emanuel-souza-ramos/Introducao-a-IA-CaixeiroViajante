...
# Heurística para resolver o problema do Caixeiro Viajante (TSP) usando Algoritmo Genético V3.
# População: 500, Tournament Size: 10
...
def main():
    ...
    print("[INFO] Matriz de distancias gerada. Iniciando o Algoritmo Genetico V3 (Pop: 500, Tournament: 10)...")
    
    # Inicializa o Algoritmo Genético V3 com os hiperparâmetros
    ga = Ga(city_dist_mat, individual_num=500, gen_num=2000, mutate_prob=0.2, patience=300, tournament_size=10)
    ...
    plt.title(f"Algoritmo Genético V3 - Melhor Rota - {map_name}")
    ...
    plt.title(f"Algoritmo Genético V3 - Evolução do Fitness - {map_name}")
    ...
    print("\n" + "=" * 50)
    print("ESTATÍSTICAS DE PERFORMANCE DA EXECUÇÃO (GA V3)")
    print("=" * 50)
