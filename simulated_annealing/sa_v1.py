...
# Classe que gerencia o ciclo do Simulated Annealing V1 (Parâmetros Padrão)
class Sa:
    def __init__(self, city_dist_mat, T_0=1000, T_f=1.5, alpha=0.95, patience=300, max_iter=2000):
