...
# Classe que gerencia o ciclo do Simulated Annealing V3 (Resfriamento Mais Rápido e Ganancioso)
class Sa:
    def __init__(self, city_dist_mat, T_0=500, T_f=1.5, alpha=0.90, patience=150, max_iter=2000):
