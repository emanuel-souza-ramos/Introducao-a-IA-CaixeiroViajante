...
# Heurística para resolver o problema do Caixeiro Viajante (TSP) usando Simulated Annealing V2.
# Parâmetros: T_0 = 1000, alpha = 0.98, patience = 300
...
def main():
    ...
    print("[INFO] Matriz de distancias gerada. Iniciando o Simulated Annealing V2...")
    
    sa = Sa(city_dist_mat, T_0=1000, T_f=1.5, alpha=0.98, patience=300)
    ...
    plt.title(f"Simulated Annealing V2 - Melhor Rota - {map_name}")
    ...
    plt.title(f"Simulated Annealing V2 - Evolução do Fitness - {map_name}")
    ...
    print("\n" + "=" * 50)
    print("ESTATÍSTICAS DE PERFORMANCE DA EXECUÇÃO (SA V2)")
    print("=" * 50)
